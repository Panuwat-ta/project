...
└── tests_report/                    # บันทึกผลการรันการทดสอบจริง (Actual Test Execution Results)
    ...
    │   ├── server/                  # รายงานฝั่ง Backend/AI (admin_api.md, api_suite_verification.md, qwen_xai.md, risk_calculator_hybrid.md, scan_xai_gpu.md, automate_test_ci.md) + archive/ (risk_calculator_weights.md สูตรเก่าที่เลิกใช้)
    ...
    └── manual_tests/                # รายงานผล manual (execution_log.md — ผลรันจริงพร้อม Pass Rate ที่คำนวณได้)
```
...
## แนวทางในการบันทึกผลการทดสอบ

1. ข้อเสนอ (ไม่บังคับ — ยังไม่มีมติทีม): หลีกเลี่ยง Emoji ในรายงานผลการทดสอบเพื่อให้ค้นหาและ diff ง่ายขึ้น
