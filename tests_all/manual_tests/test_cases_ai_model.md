...
- **Priority**: P1 (High)
- **Pre-conditions (เงื่อนไขก่อนเริ่มทดสอบ)**:
  1. มีโมเดลเวอร์ชันใช้งานอยู่และเวอร์ชัน候補รอ Deploy พร้อมไฟล์ครบ
...
- **Test Steps (ขั้นตอนการทดสอบ)**:
  1. เรียก Dry-Run ของโมเดล候補แล้วบันทึกสถานะ ความหน่วง และหน่วยความจำ
  2. รันชุดภาพอ้างอิงด้วยโมเดล候補แล้วเทียบคะแนนกับผลเดิม
  3. Deploy โมเดล候補แล้วตรวจลำดับ Active และประวัติการ Deploy
- **Expected Results (ผลลัพธ์ที่คาดหวัง)**:
