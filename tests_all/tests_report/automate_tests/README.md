...
3. **รูปแบบไฟล์ผลการทดสอบ (Test Record Format)**
   ...
   > รายงานย้อนหลังที่ไม่มี Requirement/TC mapping หรือ Commit/Build/Env ต้องระบุให้ชัดว่า “ไม่ได้บันทึกในผลรันเดิม” ห้ามเติมค่าโดยอนุมานย้อนหลัง ส่วนรายงานใหม่ต้องบันทึก metadata ทั้งหมดตามแม่แบบด้านล่าง
