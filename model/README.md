...
* **รูปแบบการประมวลผล (Inference Engine):**
  ...
  * **ตอบสนองรวดเร็ว:** สร้างข้อความสั้น 60–100 โทเค็นได้ภายใน 1–2 วินาที เมื่อรันบน CPU ระดับ x86-64 8-core / RAM ≥ 8 GB ด้วย llama-cpp-python (Q4_K_M, `n_gpu_layers=0`); เครื่องที่สเปกต่ำกว่านี้ไม่รับรองตัวเลขนี้
...
โมเดล Qwen2.5-1.5B เวอร์ชัน GGUF ใช้ไฟล์ `qwen2.5-1.5b-instruct-q4_k_m.gguf` (ขนาด ~986 MB หรือประมาณ 1.0 GB) จัดเก็บไว้ที่โฟลเดอร์ `model/Qwen2.5-1.5B/`
