...
dataset_casia_train = dict(
    ...
    data_root='dataset/dataset_CASIA2.0/',
    metainfo=dict(
        classes=(
            'background',
            'forgery',
...
defacto_root = 'dataset/DEFACTOdefacto-inpainting/'
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False,
        interval=4000,
...
existing_dirs = [
    ...
    'report.md',
    'v1.0.1',
    'segformer_v1.0.0(test-model)',
    'segformer_v2.0.0(test-model)',
]
img_ratios = [
    0.5,
    0.75,
