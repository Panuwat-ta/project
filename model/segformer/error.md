...
หากมีความจำเป็นต้องใช้ CUDA Ops แบบเต็มรูปแบบจาก `mmcv` คุณต้องติดตั้ง CUDA Toolkit **≥ 12.1** (ให้ตรงกับ PyTorch `cu121`; ตรวจด้วย `nvcc --version`) ในเครื่องให้เรียบร้อย และทำการคอมไพล์ด้วยตนเอง:
