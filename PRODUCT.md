...
## Operating Context
- ผู้ใช้งานทั่วไปใช้งานผ่าน Flutter Mobile App (Android) โดยเลือกรูปภาพจากคลังภาพ (gallery-only ยังไม่รองรับถ่ายจากกล้องใน v1) ส่งตรวจสอบ และรับผลการวิเคราะห์พร้อม Heatmap ซ้อนทับและคำอธิบายจุดน่าสงสัย
...
4. High Performance: ใช้ Redis Caching ด้วย image_hash เพื่อให้ผลการตรวจซ้ำแบบ Cache Hit ตอบกลับภายใน P95 ≤ 3 วินาที (ภาพ 1080p, เครือข่าย 4G/Wi-Fi, หน้าต่างวัด 7 วัน)

## Accessibility & Inclusion
- รองรับมาตรฐานความสามารถในการเข้าถึงขั้นพื้นฐานบน Android: Touch Target ขั้นต่ำ 48x48 dp และ Contrast Ratio ≥ 4.5:1 สำหรับข้อความปกติ (≥ 3:1 สำหรับข้อความขนาดใหญ่) ตาม WCAG 2.2 AA
