...
class AppTranslations {
  static final Map<String, Map<String, String>> localizedValues = {
    'th': {
      ...
      'history_untitled': 'รายการที่ไม่ได้ตั้งชื่อ',
      'items': 'รายการ',
      'search_history': 'ค้นหาจากชื่อที่ตั้งไว้...',
      'filter': 'กรองผลลัพธ์',
      'high_risk': 'เสี่ยงสูง',
      'suspicious': 'น่าสงสัย',
      'safe': 'ปลอดภัย',
      ...
      'delete': 'ลบ',
      'history_delete_failed': 'ลบประวัติไม่สำเร็จ กรุณาลองอีกครั้ง',
      'home': 'หน้าหลัก',
      'history': 'ประวัติ',
      'report': 'แจ้งรายงาน',
      'completed': 'เสร็จแล้ว',
      ...
      'default_user': 'ผู้ใช้งาน',
      'greeting_name': 'สวัสดี, {name}',
      'home_no_history': 'ยังไม่มีประวัติการตรวจสอบ',
      'home_untitled_scan': 'รูปภาพที่ไม่ได้ตั้งชื่อ',
      'home_scanned_at': 'สแกนเมื่อ {time}',
      'filter_all': 'ทั้งหมด',
      'history_no_results_title': 'ไม่พบผลลัพธ์',
      'history_no_risk_results': 'ไม่พบประวัติระดับ {risk}',
      'history_no_search_results': 'ไม่พบประวัติที่ตรงกับคำค้นหา',
      ...
      'result_evidence_title': 'หลักฐานจากการวิเคราะห์',
      'result_evidence_visual': 'ร่องรอยในภาพ',
      'result_evidence_text': 'ข้อความในภาพ',
      'result_evidence_source': 'ข้อมูลแหล่งที่มา',
      'result_evidence_unavailable': 'ไม่มีข้อมูลจากการวิเคราะห์ชั้นนี้',
      ...
      'report_select_scan_desc':
          'เลือกจากประวัติการตรวจสอบเพื่อแนบผลและรูปภาพที่เกี่ยวข้อง',
      'report_select_scan_empty': 'ยังไม่มีผลตรวจที่พร้อมรายงาน',
      'report_select_scan_empty_desc':
          'ตรวจสอบรูปภาพให้เสร็จก่อน แล้วกลับมาเลือกผลจากหน้านี้',
      'report_untitled_scan': 'รายการที่ไม่ได้ตั้งชื่อ',
      'report_subtitle':
      ...
      'report_specify_hint': 'โปรดระบุ',
      'report_other_category_error': 'กรุณาระบุประเภท',
      'report_other_platform_error': 'กรุณาระบุแพลตฟอร์ม',
      'report_error_network':
          'ไม่สามารถเชื่อมต่อเซิร์ฟเวอร์ได้ กรุณาตรวจสอบการเชื่อมต่ออินเทอร์เน็ต',
      'report_error_auth': 'เซสชันหมดอายุ กรุณาเข้าสู่ระบบใหม่',
      'report_error_generic': 'เกิดข้อผิดพลาด กรุณาลองใหม่อีกครั้ง',
      ...
      'auth_password_max_error': 'รหัสผ่านต้องไม่เกิน 128 ตัวอักษร',
      'auth_email_invalid': 'รูปแบบอีเมลไม่ถูกต้อง',
      'auth_consent_load_error':
          'ไม่สามารถอ่านการตั้งค่าความยินยอมได้ กรุณาลองอีกครั้ง',
      ...
      'loading_step1_title': 'กำลังตรวจสอบแหล่งที่มา',
      'loading_step1_desc_active': 'กำลังตรวจสอบข้อมูลภาพและแหล่งที่มา...',
      'loading_step2_title': 'กำลังวิเคราะห์ความผิดปกติ',
      'loading_step2_desc_active': 'กำลังวิเคราะห์ภาพด้วย AI...',
      'loading_step3_title': 'กำลังวิเคราะห์ข้อความและสรุปผล',
      'loading_step3_desc_active':
          'กำลังอ่านข้อความและสร้างคำอธิบายผลด้วย AI...',
      ...
      'loading_bg_ok': 'ตกลง',
      'loading_timeout': 'หมดเวลารอผลจากระบบ กรุณาลองใหม่',
      'loading_error_title': 'ยังวิเคราะห์ไม่สำเร็จ',
      'loading_retry': 'ลองใหม่',
      'loading_edit_image': 'กลับไปแก้ไขรูป',
      'loading_go_history': 'ไปประวัติ',
      // Notifications
      ...
      'notif_scan_failed_title': 'การสแกนล้มเหลว',
      'notif_high_risk_title': 'ตรวจพบความเสี่ยงสูง',
      'notif_scan_completed_title': 'สแกนเสร็จสิ้น',
      'notif_scan_failed_body': 'รูป {id} ประมวลผลไม่สำเร็จ',
      'notif_scan_score_body': '{title} — คะแนนความเสี่ยง {score}%',
      'notif_image_default': 'รูปภาพ',
      'notif_just_now': 'เมื่อสักครู่',
      'notif_minutes_ago': '{count} นาทีที่แล้ว',
      ...
      'crop_zoom': 'ขยาย',
      'crop_edit_error': 'ไม่สามารถแก้ไขรูปภาพได้ กรุณาลองอีกครั้ง',
      'crop_reset': 'รีเซ็ต',
      'crop_info':
      ...
      'crop_name_hint': 'ตั้งชื่อเพื่อค้นหาภายหลัง (ไม่บังคับ)',
      // Heatmap
      ...
      'heatmap_unavailable_short': 'ไม่มี Heatmap',
      'heatmap_hide_overlay': 'ซ่อน Heatmap',
      'heatmap_show_overlay': 'แสดง Heatmap',
      'heatmap_unavailable_desc':
          'ไม่มีข้อมูล Heatmap สำหรับภาพนี้ ระบบจะแสดงเฉพาะภาพต้นฉบับโดยไม่สร้างจุดผิดปกติจำลอง',
      ...
      'history_text_keywords_summary':
          'ระบบรายงานคำสำคัญที่มีความเสี่ยง {count} คำ: {keywords}',
      'history_text_risk_detected':
          'ระบบรายงานคะแนนความเสี่ยงจากการวิเคราะห์ข้อความ',
      'history_text_no_risk_detected':
          'ระบบไม่รายงานคำสำคัญที่มีความเสี่ยงจากชั้นข้อความ',
    ...
    'en': {
      ...
      'history_untitled': 'Untitled scan',
      'items': 'Items',
      'search_history': 'Search by saved name...',
      'filter': 'Filter',
      'high_risk': 'High Risk',
      ...
      'delete': 'Delete',
      'history_delete_failed': 'Could not delete history. Please try again.',
      'home': 'Home',
      'history': 'History',
      'report': 'Report',
      'completed': 'Completed',
      ...
      'home_no_history': 'No scan history yet',
      'home_untitled_scan': 'Untitled image',
      'home_scanned_at': 'Scanned at {time}',
      'filter_all': 'All',
      'history_no_results_title': 'No results',
      'history_no_risk_results': 'No {risk} history found',
      'history_no_search_results': 'No history matches your search',
      ...
      'permission_photo_title': 'Photo access required',
      'permission_photo_desc':
      ...
      'result_evidence_title': 'Analysis Evidence',
      'result_evidence_visual': 'Visual Evidence',
      'result_evidence_text': 'Text Evidence',
      'result_evidence_source': 'Source Evidence',
      'result_evidence_unavailable':
          'No data is available for this analysis layer',
      'result_evidence_score_only':
      ...
      'report_select_scan_desc':
          'Choose a completed scan from history to attach its result and image.',
      'report_select_scan_empty': 'No completed scans to report',
      'report_select_scan_empty_desc':
          'Complete an image scan first, then return here to select it.',
      'report_untitled_scan': 'Untitled scan',
      'report_subtitle':
      ...
      'report_specify_hint': 'Please specify',
      'report_other_category_error': 'Please specify a category',
      'report_other_platform_error': 'Please specify a platform',
      'report_error_network':
          'Could not connect to the server. Check your internet connection.',
      'report_error_auth': 'Your session has expired. Please log in again.',
      'report_error_generic': 'Something went wrong. Please try again.',
      'cat_romance': 'Romance Scam',
      ...
      'auth_password_max_error': 'Password must be at most 128 characters',
      'auth_email_invalid': 'Invalid email format',
      'auth_consent_load_error':
          'Could not read consent settings. Please try again.',
      ...
      'loading_step1_title': 'Checking image source',
      'loading_step1_desc_active': 'Checking image metadata and source...',
      'loading_step2_title': 'Analyzing visual anomalies',
      'loading_step2_desc_active': 'Analyzing the image with AI...',
      'loading_step3_title': 'Analyzing text and preparing summary',
      'loading_step3_desc_active':
          'Reading text and generating the AI explanation...',
      ...
      'loading_bg_ok': 'OK',
      'loading_timeout': 'The analysis timed out. Please try again.',
      'loading_error_title': 'Analysis not completed',
      'loading_retry': 'Try Again',
      'loading_edit_image': 'Edit Image',
      'loading_go_history': 'Go to History',
      // Notifications
      ...
      'notif_scan_failed_title': 'Scan failed',
      'notif_high_risk_title': 'High risk detected',
      'notif_scan_completed_title': 'Scan completed',
      'notif_scan_failed_body': 'Image {id} could not be processed',
      'notif_scan_score_body': '{title} — Risk score {score}%',
      'notif_image_default': 'Image',
      ...
      'crop_zoom': 'Zoom',
      'crop_edit_error': 'Could not edit the image. Please try again.',
      'crop_reset': 'Reset',
      'crop_info':
      ...
      'crop_name_hint': 'Name this scan for later search (optional)',
      // Heatmap
      'heatmap_ready': 'Ready',
      ...
      'heatmap_unavailable_short': 'Heatmap unavailable',
      'heatmap_hide_overlay': 'Hide Heatmap',
      'heatmap_show_overlay': 'Show Heatmap',
      'heatmap_unavailable_desc':
          'No heatmap data is available for this image. Only the original image is shown; no anomaly overlay is simulated.',
      ...
      'history_no_suspicious_keywords':
          'No suspicious keywords were reported by the system',
      'history_text_keywords_summary':
          'The system reported {count} risk-related keywords: {keywords}',
      'history_text_risk_detected':
          'The system reported a risk score from text analysis.',
      'history_text_no_risk_detected':
          'The text layer did not report risk-related keywords.',
