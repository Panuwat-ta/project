        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.path}
              onClick={closeSidebar}
              className={`flex items-center justify-between px-3 py-2 rounded-md text-sm transition-colors outline-none focus:ring-2 focus:ring-indigo-500 ${isActive ? "bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 font-medium" : "text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-100"
                }`}
            >
        ...
        {isDropdownOpen && (
          <div className="absolute bottom-full left-3 w-56 mb-2 bg-white dark:bg-slate-900 rounded-md shadow-lg border border-slate-200 dark:border-slate-800 py-1 overflow-hidden">
            ...
            <button
              ...
              className="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 flex items-center gap-2 transition-colors outline-none focus:bg-red-50 dark:focus:bg-red-500/10"
            >
