...
export function ReportsList() {
  ...
  return (
    <div className="space-y-5">
      ...
      <Card>
        <div className="p-4 flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800/80">
          {/* Status Tabs */}
          <Tabs
            tabs={STATUS_TABS}
            activeTab={activeTab}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell onClick={(e) => e.stopPropagation()}>
                          <div className="size-11 rounded-lg border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-950 flex items-center justify-center relative group shrink-0">
                            {thumbUrl ? (
                              <img
                                src={thumbUrl}
                                alt="Report Preview"
