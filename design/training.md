...
## 2. Dataset Design
* การคัดเลือกชุดข้อมูลภาพ (Dataset) ที่ประกอบไปด้วยภาพปกติและภาพตัดต่อ (Forged) เช่น สลิปธนาคารปลอม, เอกสารราชการดัดแปลง หรือชุดข้อมูลมาตรฐาน (CASIA, IMD2020)
...
* **Data Augmentation**: การทำภาพเบลอ, เพิ่ม Noise, การบีบอัด JPEG (JPEG Compression), ปรับแสงสว่าง และหมุนภาพ เพื่อเพิ่มความทนทาน (Robustness) แก่โมเดล
...
## 5. Fine-tuning
* การปรับจูนโมเดลกับชุดข้อมูลแบบเฉพาะเจาะจง (เช่น สลิปโอนเงินธนาคารในไทย)
...
## 7. Freeze Encoder
* เทคนิคการระงับการอัปเดตน้ำหนัก (Weights) ของชั้น MiT Encoder ชั่วคราวในช่วง Fine-tuning 
* ปล่อยให้ระบบสอนเฉพาะส่วน SegFormer Decoder เท่านั้น เพื่อลดระยะเวลาการประมวลผลและลดโอกาสการเกิด Overfitting จากชุดข้อมูลใหม่ที่มีจำนวนจำกัด
...
## 11. Hyperparameters
* การจัดการตัวแปรสภาพแวดล้อมระหว่างการเทรน ได้แก่ Batch Size, Optimizer (เช่น AdamW), Learning Rate Schedulers, และ Loss Function (เช่น Dice Loss ควบคู่กับ CrossEntropy)
