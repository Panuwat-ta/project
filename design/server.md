...
*หมายเหตุ: รายละเอียดสถาปัตยกรรมท่อประมวลผล (Inference Pipeline) และการสลับใช้งานโมเดล (Dynamic Update) ถูกย้ายไปที่เอกสาร [model.md](./model.md) เพื่อรวมการออกแบบที่เกี่ยวกับ AI ไว้ในที่เดียวกัน*
