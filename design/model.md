...
## 4. โครงสร้างข้อมูล
* **Input**: โครงสร้างแบบ Tensor ขนาด `[Batch, Channel, Height, Width]` เช่น `[1, 3, 512, 512]`
...
* **Risk Score**: ค่าตัวเลขรวมที่คำนวณจากความรุนแรงและขนาดของพื้นที่ที่ตรวจพบความผิดปกติ เพื่อใช้ประเมินความเสี่ยงทั้งหมดของภาพ
