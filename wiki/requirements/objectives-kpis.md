...
พัฒนา Mobile App แบบ Cross-Platform เพื่อให้ผู้ใช้ทั่วไปเลือกรูปต้องสงสัยจากคลังภาพ (เช่น สลิปโอนเงิน, รูปโปรไฟล์) แล้วส่งให้ระบบวิเคราะห์หาความเสี่ยง
...
| :--- | :--- |
| ความแม่นยำ AI (ภาพตัดต่อ + AI-Gen) | Accuracy และ mDice >= 85% บน Test Set |
