...
| :--- | :--- |
| **NFR-01** | **ประสิทธิภาพความเร็ว (Performance):** ระบบต้องดึงผลลัพธ์จาก Cache ด้วย SHA-256/Redis ได้ภายใน 3 วินาที และหากต้องประมวลผลผ่าน AI ใหม่ทั้งหมด (Full inference P50 ≤ 15s) ต้องใช้เวลาไม่เกิน 15 วินาทีต่อภาพ |
...
| **NFR-05** | **การรองรับการใช้งาน:** แอปพลิเคชันฝั่งผู้ใช้ (Mobile App) เป็น Flutter cross-platform |
...
| **NFR-07** | **ความเสถียรภาพ (Availability):** ระบบต้องมีเสถียรภาพสูง พร้อมใช้งาน **Uptime ≥ 99.5%** (ไม่นับ Planned Maintenance) และมีระบบจัดการข้อผิดพลาด (Error Handling) ที่ไม่ทำให้แอปพลิเคชันปิดตัวลงกะทันหัน (Crash) |
