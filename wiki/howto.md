...
**เอกสารที่ยังไม่ได้ ingest ครบ:**

| ไฟล์ | สถานะ |
| :--- | :--- |
| `doc/srs.md` | ingest บางส่วน — หน้า FR ยังไม่ครบ |
| `doc/Use-Case-Diagram.md` | ยังไม่ได้ ingest |
| `doc/flowchart.md` | ยังไม่ได้ ingest |
| `doc/C1-System-Context-Diagram.md` | ยังไม่ได้ ingest |
| `doc/C2-Container-Diagram.md` | ยังไม่ได้ ingest |
| `design/design.md` | ยังไม่ได้ ingest |
| `design/mobile.md` | ยังไม่ได้ ingest |
| `design/training.md` | ยังไม่ได้ ingest |
