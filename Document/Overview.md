...
## 5. ลอจิกคะแนนและระดับความเสี่ยง

ระบบรวมผลการวิเคราะห์หลายชั้นเป็นคะแนนเดียวด้วยค่าเฉลี่ยถ่วงน้ำหนัก ตามลอจิกใน `server/app/utils/risk_calculator.py`:
...
|---|---|---:|
| $S_{total}$ | คะแนนความเสี่ยงรวม (0–100) | — |
| $S_{visual}$ | คะแนนความผิดปกติทางภาพจากโมเดล SegFormer | 45% |
| $S_{textual}$ | คะแนนความเสี่ยงของข้อความจาก OCR + NLP | 25% |
| $S_{source}$ | คะแนนความเสี่ยงจากความน่าเชื่อถือ/บริบทของแหล่งที่มาภาพ | 30% |

คะแนนด้านภาพมีน้ำหนักมากที่สุด เพราะเป็นสัญญาณเชิงนิติวิทยาศาสตร์จากการประมวลผลระดับพิกเซลโดยตรง ส่วนคะแนนแหล่งที่มาช่วยสะท้อนบริบทของการเผยแพร่ภาพบนอินเทอร์เน็ต ขณะที่คะแนนข้อความให้น้ำหนักน้อยกว่า เนื่องจากข้อความอาจตีความได้หลายบริบท และภาพบางชนิดอาจไม่มีข้อความ

ผลลัพธ์คือผู้ใช้ได้รับคะแนนเดียวที่อ่านและใช้ตัดสินใจเบื้องต้นได้รวดเร็ว โดยยังคงสะท้อนทั้งร่องรอยการตัดต่อ/ภาพ AI, ข้อความหลอกลวง และข้อมูลแหล่งที่มาของภาพ

ในเชิง implementation ให้ปัดหรือจำกัดผลลัพธ์สุดท้ายให้อยู่ในช่วง 0–100 ก่อนส่งกลับเป็น `risk_score`:

```text
risk_score = round(text_score × 0.25
                 + visual_score × 0.45
                 + source_score × 0.30)
```
