...
\text{Risk Grade} = 
\begin{cases} 
\text{Low / Safe (ปลอดภัย)} & \text{if } S_{total} \le 39 \\
\text{Medium / Suspicious (น่าสงสัย)} & \text{if } 40 \le S_{total} \le 69 \\
\text{High / Danger (อันตราย)} & \text{if } S_{total} \ge 70 
\end{cases}
$$

**คำอธิบายและเหตุผลที่ใช้:**
* **ช่วงปลอดภัย (0 – 39):** คะแนนตกอยู่ในช่วงที่ทุกชั้นการวิเคราะห์ (ภาพ ข้อความ และแหล่งที่มา) ไม่มีลักษณะเข้าข่ายการหลอกลวง ถือว่าเชื่อถือได้ในระดับสูง
