...
* คืนค่าผลลัพธ์เป็น Segmentation Mask ซึ่งจะถูกแปลง (Post-Processing) ให้อยู่ในรูปของ **แผนที่ความร้อนแบบ mask-to-heatmap overlay** เพื่อใช้วางซ้อน (Overlay) บนรูปต้นฉบับ
