...
## ข้อมูลทั่วไป
**Surya-OCR** เป็นโมเดลสำหรับอ่านตัวอักษรและวิเคราะห์โครงสร้างเอกสารระดับสูง โดยในโปรเจกต์นี้เลือกใช้เวอร์ชัน **0.5.0 (Native PyTorch)** เพื่อเสถียรภาพสูงสุดและการปรับจูนประสิทธิภาพด้วยไลบรารี PyTorch (CUDA) โดยตรง

* **คุณสมบัติหลัก (Key Features):**
  * **Multi-lingual Support:** รองรับการอ่านมากกว่า 90 ภาษาตาม model card ของผู้พัฒนา Surya v0.5.0 รวมทั้งภาษาไทยและอังกฤษ (เกณฑ์รับรอง: อ่านไทย/อังกฤษบนภาพ ≥720px ได้ถูกต้อง — ดูเกณฑ์ OCR ใน `design/mobile/requirements.md` REQ-005)
...
> หมายเหตุ: Surya OCR v0.5.0 (Native PyTorch) จะใช้สำหรับสกัดข้อความ ส่วนโมเดลภาษาขนาดเล็กจะใช้เฉพาะสร้างคำอธิบาย XAI เท่านั้น
