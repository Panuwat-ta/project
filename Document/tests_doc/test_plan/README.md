...
|---|---|---|---|---|---|
| คำถามที่หนึ่ง | การสกัดข้อความรองรับภาษาไทยและภาษาอังกฤษเท่านั้นหรือไม่ และเกณฑ์ความแม่นยำของสองภาษาที่เขียนไว้ต่างกันเป็นความตั้งใจหรือไม่ | ข้อกำหนด OCR ภาษาไทยและอังกฤษในเอกสารวิเคราะห์หลายชั้น | ทดสอบเฉพาะภาษาไทยและภาษาอังกฤษ ภาษาอื่นถือว่าอยู่นอกขอบเขต เกณฑ์ภาษาไทยไม่ต่ำกว่าร้อยละแปดสิบ ภาษาอังกฤษไม่ต่ำกว่าร้อยละแปดสิบห้า | รอเจ้าของผลิตภัณฑ์ยืนยัน | หัวหน้าโครงงานและอาจารย์ที่ปรึกษา |
| คำถามที่สอง | การลบข้อมูลสแกนและภาพเมื่อครบหนึ่งปี มีงานอัตโนมัติรายวันเวลาตีสองจริงหรือไม่ เพราะตารางสอบย้อนกลับระบุว่ายังไม่มีงานดังกล่าว | นโยบายเก็บข้อมูลหนึ่งปีและรายละเอียดงานรายวัน | รอบนี้ทดสอบเฉพาะการลบด้วยตนเองของเจ้าของข้อมูล ส่วนการลบอัตโนมัติครบหนึ่งปีให้ถือว่าเลื่อนไปก่อนจนกว่าจะมีงานดังกล่าวจริง | รอทีมพัฒนายืนยัน | ทีมหลังบ้าน |
...
| คำถามที่แปด | การเก็บรุ่นโมเดลสำรองสามรุ่นกับการมีรุ่นใช้งานเพียงหนึ่งเดียวว่าขัดกันหรือไม่ | การบริหารรุ่นโมเดลและการสลับใช้งาน | ให้ยึดว่ามีรุ่นใช้งานได้เพียงหนึ่งเดียวเสมอ ส่วนรุ่นสำรองเก็บได้ไม่เกินสามรุ่น การลบรุ่นเก่าทำได้เมื่อเกินสามรุ่นและห้ามลบรุ่นที่ใช้งานอยู่ | ยืนยันแล้วตามเอกสาร | ทีมแอดมินและทีมปัญญาประดิษฐ์ |
