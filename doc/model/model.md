...
### Surya-OCR
**Surya-OCR** เป็นโมเดลสำหรับอ่านตัวอักษรและวิเคราะห์โครงสร้างเอกสารสมัยใหม่ (Modern OCR) ขับเคลื่อนด้วย Deep Learning เพื่อลดข้อผิดพลาดที่มักเกิดใน OCR ยุคเก่า

* **คุณสมบัติหลัก (Key Features):**
  * **Multi-lingual Support:** รองรับการอ่านภาษาไทยและภาษาอังกฤษได้อย่างแม่นยำ ทนทานต่อรูปแบบฟอนต์ที่หลากหลาย
  ...
  * **Robust to Noise:** ทนทานต่อภาพที่มีความละเอียดต่ำ ภาพเบลอ หรือภาพที่ผ่านการบีบอัดไฟล์ (JPEG Compression) ผ่านแอปแชต
* **บทบาทในระบบ:**
  * รับรูปภาพอินพุตมาเพื่อหากล่องข้อความ (Text Detection) และแปลงออกมาเป็นสตริงข้อความ (Text Recognition)
